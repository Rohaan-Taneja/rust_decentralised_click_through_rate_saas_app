...
pub mod sql_types {
    ...
    #[diesel(postgres_type(name = "creator_txn_status"))]
    pub struct CreatorTxnStatus;
...
diesel::table! {
    ...
    use super::sql_types::CreatorTxnStatus;

    creators_payment (id) {
        id -> Uuid,
        creator_wallet_address -> Varchar,
        txh_sign -> Nullable<Varchar>,
        payment_status -> CreatorTxnStatus,
